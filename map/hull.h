...
#define MAXDIM 4 /* originally 8 */

// if we take 100000 and 5 (or 100000 and 3) for these,
// after a while (a few hundred calls) ClarksonDelaunay returns ctet=1 bogusly.
#define BLOCKSIZE 10000 /*;;100000*/
#define MAXBLOCKS 3 /*;;1000*/
#define HULLDEBUG 0 /*-7*/
...
#define DEBS(qq)  {if (HULLDEBUG>qq) {
#define EDEBS }}
#define DEBOUT DFILE
...
extern Coord infinityPoint[10];	/* point at infinity for Delaunay triang */
...
typedef /*void * was this -- CG*/ simplex* visit_func(simplex *, void *);
